...
Partial Class Chartview
    ...
    Private Sub InitializeComponent()
        ...
        'Me.InkomendeFacturenTableAdapter = New dsInkomendeFacturenTableAdapters.TableAdapterManager 'dxCookBook.SSLTESTDataSet1TableAdapters.InkomendeFacturenTableAdapter()
