...
Public Class ErrorIconTextBox
    Dim icon1 As Image = Image.FromFile("\\burandoholding.int\shares\UserData\lucas.hartman\My Documents\My Pictures\Profile\fv2.jpg")
